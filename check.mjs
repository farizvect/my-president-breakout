...
console.log(`ok — ${tickers.length} emiten, semua logo ada, grid clear ${PADDLE_Y - (TOP + ROWS * CELL_H)}px, `
  + `${quotes.length} kutipan, IHSG ${open} -> minimum ${worst} (drop: ${drop.trim()})`);
